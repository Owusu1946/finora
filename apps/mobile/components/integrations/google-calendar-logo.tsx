...
/**
 * Official Google Calendar icon (2020–present).
 * Source: Google / Wikimedia Commons — Google_Calendar_icon_(2020).svg
 * https://commons.wikimedia.org/wiki/File:Google_Calendar_icon_(2020).svg
 */
export function GoogleCalendarLogo({ width = 22, height }: LogoProps) {
