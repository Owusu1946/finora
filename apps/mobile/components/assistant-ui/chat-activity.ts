...
const TOOL_ACTIVITY: Record<string, ChatActivity> = {
  ...
  search_web: { orbState: 'searching', label: 'Searching the web...' },
  search_products: { orbState: 'searching', label: 'Checking product listings and prices...' },
  research_web: { orbState: 'weaving', label: 'Researching across web sources...' },
  read_web_page: { orbState: 'working', label: 'Reading the selected web source...' },
