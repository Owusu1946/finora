...
>(name: N, camel: Camel, category: Cat, surfaces: S, risk: R, description: string) {
...
export const TOOL_REGISTRY = [
  ...
  t(
    ...
    ['platform'],
    'execute',
    'Create Finora account and start onboarding',
  ),
  ...
  t(
    ...
    ['mobile', 'platform'],
    'execute',
    'Create transaction PIN / passcode',
  ),
  t(
    'verify_pin',
    'verifyPIN',
    ...
    ['mobile', 'platform'],
    'execute',
    'Verify transaction PIN (human gate)',
  ),
  t(
  ...
  t(
    ...
    ['platform'],
    'prepare',
    'Create WeWire-backed sub-customer profile',
  ),
  t(
    ...
    ['platform'],
    'read',
    'Return financial account details',
  ),
  t(
    'list_subcustomers',
    'listSubcustomers',
  ...
  t(
    ...
    ['platform'],
    'prepare',
    'Prepare internal wallet transfer',
  ),
  t(
    'execute_approved_wallet_transfer',
    'executeWalletTransfer',
    'wallets',
    ['platform', 'mobile'],
    'execute',
    'Execute wallet transfer after approval',
  ),
  ...
  t(
    'share_virtual_account',
    'shareVirtualAccount',
    'virtual_accounts',
    ['platform', 'mobile'],
    'read',
    'Shareable VA payment details',
  ),
  ...
  t(
    'execute_approved_crypto_transfer',
    'executeCryptoTransfer',
    'crypto',
    ['platform', 'mobile'],
    'execute',
    'Execute crypto transfer after approval',
  ),
  t(
  ...
  t(
    'lookup_crypto_recipient',
    'lookupCryptoRecipient',
    'lookup',
    ['platform'],
    'read',
    'Lookup crypto recipient',
  ),
  t(
    'resolve_recipient',
    'resolveRecipient',
    ...
    ['platform'],
    'read',
    'Resolve names like Ama',
  ),
  t(
    'resolve_duplicate_recipients',
    'resolveDuplicateRecipients',
    'lookup',
    ['platform'],
    'read',
  ...
  t(
    ...
    ['platform', 'mobile'],
    'read',
    'Resolve a Finora Tag to a verified Finora account',
  ),
  t(
    'search_recipient',
    'searchRecipient',
    ...
    ['platform', 'mcp'],
    'read',
    'Search / resolve recipients (MCP high-level)',
  ),
  ...
  t(
    ...
    ['platform', 'mcp'],
    'prepare',
    'Prepare payout for human approval',
  ),
  t(
  ...
  t(
    ...
    ['platform', 'mobile'],
    'execute',
    'Execute after human approval + PIN',
  ),
  t(
    'cancel_payment',
    'cancelPayment',
  ...
  t(
    ...
    ['platform', 'mobile'],
    'prepare',
    'Repeat previous payment (re-prepare)',
  ),
  ...
  t(
    ...
    ['platform'],
    'read',
    'Block until payment reaches a terminal status (server-side poll)',
  ),
  t(
  ...
  t(
    ...
    ['platform', 'mcp'],
    'prepare',
    'Prepare FX conversion for approval',
  ),
  t(
    ...
    ['platform', 'mobile'],
    'execute',
    'Execute conversion after approval',
  ),
  ...
  t(
    ...
    ['platform'],
    'read',
    'VA / MoMo / crypto receive options',
  ),
  t(
  ...
  t(
    'share_receive_details',
    'shareReceiveDetails',
    'receive',
    ['mobile'],
    'local',
    'Share receiving information',
  ),
  ...
  t(
    'get_invoice_source_email',
    'getInvoiceSourceEmail',
    'gmail',
    ['platform'],
    'read',
    'Source email for an invoice (from/subject)',
  ),
  ...
  t(
    ...
    ['platform'],
    'prepare',
    'Prepare recurring schedule',
  ),
  t(
    'execute_approved_recurring_payment',
    'executeRecurringPayment',
    'recurring',
    ['platform', 'mobile'],
    'execute',
    'Activate recurring after approval',
  ),
  t(
  ...
  t(
    'execute_approved_supplier_payment',
    'executeSupplierPayment',
    'business',
    ['platform', 'mobile'],
    'execute',
    'Execute supplier payment after approval',
  ),
  t(
    'create_employee',
    'createEmployee',
  ...
  t(
    ...
    ['platform', 'mobile'],
    'prepare',
    'Prepare one-off employee payment',
  ),
  t(
    'execute_approved_payroll',
    'executePayroll',
    'business',
    ['platform', 'mobile'],
    'execute',
    'Execute payroll after approval + PIN',
  ),
  t(
    ...
    ['platform', 'mobile'],
    'read',
    'Treasury / cash position overview',
  ),
  t(
    'list_expenses',
    'listExpenses',
  ...
  t(
    ...
    ['platform', 'mcp'],
    'prepare',
    'Build a multi-item money plan for one approval',
  ),
  t(
    'get_financial_plan',
    'getFinancialPlan',
  ...
  t(
    'cancel_financial_plan',
    'cancelFinancialPlan',
    'plans',
    ['platform'],
    'prepare',
    'Cancel a draft / pending plan',
  ),
  t(
    'execute_approved_financial_plan',
    'executeFinancialPlan',
    'plans',
    ['platform', 'mobile'],
    'execute',
    'Execute all plan items after approval',
  ),
  ...
  t(
    ...
    ['platform', 'mcp'],
    'prepare',
    'Open an agent transaction spanning related prepares',
  ),
  t(
    'commit_transaction',
    'commitTransaction',
    ...
    ['platform', 'mcp'],
    'prepare',
    'Commit agent transaction → request human approval for all items',
  ),
  t(
    ...
    ['platform', 'mcp'],
    'prepare',
    'Roll back agent transaction and cancel preparations',
  ),
  ...
  t(
    ...
    ['platform', 'mcp'],
    'prepare',
    'Notify human of pending approval / plan',
  ),
  t(
    'approve_transaction',
    'approveTransaction',
    ...
    ['platform', 'mobile'],
    'execute',
    'Human approves (decision only; does not settle rails)',
  ),
  t(
    'reject_transaction',
    'rejectTransaction',
    ...
    ['platform', 'mobile'],
    'execute',
    'Human rejects transaction',
  ),
  t(
    'verify_biometric_approval',
  ...
  t(
    ...
    ['platform'],
    'execute',
    'Create spending / approval policy',
  ),
  ...
  t(
    ...
    ['platform'],
    'execute',
    'Assign policy to account / wallet / user',
  ),
  t(
    'simulate_policy',
    'simulatePolicy',
    ...
    ['platform'],
    'read',
    'Dry-run policy against a hypothetical action',
  ),
  t(
    'evaluate_policy',
    'evaluatePolicy',
    ...
    ['platform', 'mcp'],
    'read',
    'Evaluate policy for an action (alias check_policy)',
  ),
  t(
    'check_policy',
    'checkPolicy',
    ...
    ['platform'],
    'read',
    'Evaluate policy before prepare',
  ),
  t(
    'get_audit_logs',
    'getAuditLogs',
  ...
  t(
    ...
    ['platform'],
    'read',
    'Supported MoMo / card / crypto networks',
  ),
  ...
  t(
    ...
    ['platform', 'mcp', 'mobile'],
    'read',
    'Bundle of recent recipients / wallets / txs',
  ),
  t(
    'resolve_last_recipient',
    'resolveLastRecipient',
    'context',
    ['platform', 'mobile'],
    'read',
    'Resolve “her/him/them” to last recipient',
  ),
  t(
    'resolve_last_wallet',
    'resolveLastWallet',
  ...
  t(
    ...
    ['platform', 'mobile'],
    'read',
    'List upcoming calendar money events',
  ),
  t(
    'list_sms_requests',
    'listSmsRequests',
    ...
    ['platform', 'mobile'],
    'read',
    'List payment requests from SMS inbox',
  ),
  t(
    'connect_whatsapp',
    'connectWhatsApp',
  ...
  t(
    ...
    'recommendPaymentRoute',
    'intelligence',
    ['platform'],
    'read',
    'Recommend end-to-end payment route',
  ),
  t(
    'recommend_payment_schedule',
    'recommendPaymentSchedule',
    'intelligence',
    ['platform'],
    'read',
    'Recommend when to pay',
  ),
  t(
    'recommend_funding_source',
    'recommendFundingSource',
    'intelligence',
    ['platform'],
    'read',
    'Recommend funding wallet / rail',
  ),
  t(
    'find_best_wallet',
    'findBestWallet',
  ...
  t(
    ...
    ['platform'],
    'read',
    'Pick best currency for a payment',
  ),
  t(
  ...
  t(
    ...
    ['platform', 'mobile'],
    'execute',
    'Run automation (may prepare payments only)',
  ),
  ...
  t(
    ...
    ['platform'],
    'prepare',
    'Alias of create_financial_account',
  ),
  t(
    'get_subcustomer',
    'getSubcustomer',
    ...
    ['platform'],
    'read',
    'Alias of get_financial_account',
  ),
  t(
    'submit_subcustomer_kyc',
    'submitSubcustomerKyc',
    'kyc',
    ['platform'],
    'prepare',
    'Alias of submit_kyc',
  ...
  t(
    ...
    'getSubcustomerKycLink',
    'kyc',
    ['platform'],
    'read',
    'Alias of get_kyc_link',
  ),
  t(
    ...
    ['platform'],
    'read',
    'Alias of list_kyc_requirements',
  ),
] as const;
